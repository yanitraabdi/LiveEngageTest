...
namespace LiveChatApiExample
{
    public class ApiExample
    {
        ...
        public ApiExample()
        {
            ...
            Api = new LiveChatApi.Api("christian.candra@aia.com", "b41ce3e5656e3f19b9d8bbb68f73c9e6");  
        }
        ...
        public async Task ArchivesTest()
        {
            ...
            parameters.Add("include_pending", "1");
        ...
        public async Task ChatTest()
        {
            ...
            string visitorID = "S1505103345.fe435b6616";
            string licenseID = "9088395";
            string welcomeMessage = "Boi";
            string result = await Api.Chat.TestChat(visitorID, licenseID, welcomeMessage);
            Console.WriteLine(result);

            Console.ReadLine();

            //Console.WriteLine("Get pending messages");
            //string sessionID = "CS1505115465.4fe07ae49d";
            ...
            //string sessionID = "CS1505189244.3b580fe385";
